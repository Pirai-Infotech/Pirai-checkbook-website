    ...
    <div className="px-4 sm:px-0">
      <section className="container main-con m-auto mt-8 md:mt-10 lg:mt-14 pb-10 md:pb-12 lg:pb-20">
        <div className="flex flex-col lg:flex-row items-center gap-10">
          <h1 className="text-center lg:text-left text-[45px] lg:text-[30px] xl:text-[40px] 2xl:text-[52px] 3xl:text-[70px] leading-[43.59px] sm:leading-[54px] lg:leading-[30px] xl:leading-[40px] 2xl:leading-[60px] 3xl:leading-[75px] text-dk sm:px-[20%] lg:px-[0]">
          ...
          <div className="flex flex-col md:flex-row  gap-5">
            {items.map((item, index) => (
              <div
                key={index}
                className="text-center bg-gradient-to-r from-[#9281FF] to-[#3E89BD] py-2 px-10 rounded-[10px] min-w-[245px] lg:min-w-[200px] 2xl:min-w-[250px] h-[140px] sm:h-[150px]"
              >
