...
function Horizhoverhm({ heading, description, listitems }) {
  ...
  return (
    <div className="container m-auto p-4 sm:p-6 pb-10 md:p-10 md:w-[75%] lg:w-full 2xl:p-0 grad-border grad-border-rtgs bdr-home-rds md:py-10 lg:gap-3 lg:px-30 2xl:px-52 2xl:py-[100px]">
