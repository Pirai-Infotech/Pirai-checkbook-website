...
function ReadytoGetStart() {
  return (
    <div className="container m-auto flex flex-col lg:flex-row items-center gap-8 py-10">
      <div className="lg:p-7 grad-border-rtgs bdr-sm-rds no-bdr flex-grow-1 xl:w-[60%]">
      ...
      <div className="flex flex-col md:flex-row items-center gap-8">
        <div className="py-10 px-10 sm:px-20 md:py-10 md:px-10 lg:p-[20px] xl:p-[70px] grad-border-compliance bdr-sm-rtgs lin-bf-txt2">
          <div className="flex flex-row lg:flex-col  items-center xl:items-start gap-5">
            <Image src={payicogray} className="hidden lg:block" alt="What you Pay" />
            <Image src={payico} className="block lg:hidden" alt="What you Pay" />
        ...
        <div className="py-10 px-10 sm:px-20 md:py-10 md:px-10 lg:p-[20px] xl:p-[70px] grad-border-syi bdr-sm-rtgs lin-bf-txt">
          <div className="flex flex-row lg:flex-col  items-center xl:items-start gap-5">
            <Image src={codeicogray} className="hidden lg:block" alt="What you Pay" />
            <Image src={codeico} className="block lg:hidden" alt="What you Pay" />
