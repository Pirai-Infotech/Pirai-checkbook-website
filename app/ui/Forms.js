  ...
  return (
    <div className="2xl:px-[250px] container main-con m-auto my-8 md:my-10 lg:my-14">
      <div className="lg:relative border-2 border-[#404040] rounded-[52px] lg:rounded-[70px]">
        <h1 class="lg:absolute mt-6 lg:mt-0 lg:top-0 lg:left-1/2 lg:transform lg:-translate-x-1/2 lg:-translate-y-1/2 lg:bg-white 2xl:px-28 font-inter font-medium text-[24px] 2xl:text-[44px] leading-[53px] text-center text-[#404040]">
          Save your spot
          <p className="font-inter font-normal text-[18px] 2xl:text-[28px] leading-[43.59px] lg:leading-[52px] text-[#8C82FB]">
            Thursday, July 11th | 9:00 am PT
          </p>
        </h1>
