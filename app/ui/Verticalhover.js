...
function Verticalhover({ heading, spancon, description, items, imageSrc }) {
  ...
  return (
    <>
    <div className="pt-10">
    <div className="container m-auto lg:px-[26%]">
    ...
    <div className="ml-2 pl-2 sm:ml-10 sm:pl-10 md:ml-14 md:pl-14 2xl:ml-36 2xl:pl-36 flex flex-row items-center justify-between gap-2 lg:gap-8 py-10">
      <div className="w-[60%] 2xl:w-[36%] h-[500px]">
        {items?.map((item, index) => (
          <div
            ...
            <h4 className={`transition-opacity transition-visibility duration-500 lg:pl-4 2xl:text-[40px] opacity-100 ${toHandelhover(index) ? `text-[#7F53E7] opacity-100` : `text-[#404040] opacity-0`}`}>
              {`0${index + 1}`}
            </h4>
