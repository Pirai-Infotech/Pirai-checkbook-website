...
function page() {
  return (
    <div className="px-5 sm:px-0">
      ...
      <section className="lg:bg-gradient-to-r lg:from-transparent lg:via-transparent lg:to-white mt-6 sm:mt-8 md:mt-10">
        <div className="container m-auto relative block sm:flex lg:block sm:w-[100%] sm:gap-8">
          ...
          <div className="block lg:flex lg:w-[100%]">
            <div className="lg:w-[50%] flex lg:items-center lg:justify-center lg:h-[500px] sm:pl-8">
              <div>
                ...
                <p className="font-circular-spotify text-[16px] lg:text-[18px] font-light leading-[22.58px] lg:leading-[25.4px] text-left text-[#4F535B] mt-4 md:mt-8 lg:w-[433px]">
              ...
              <div className="absolute z-[-1] right-[0%] md:right-[7%] lg:right-[14%] top-[300px] md:top-[300px] lg:top-[-100px]">
        ...
        <div className="mt-10 sm:mt-0 lg:mt-28 sm:w-[50%] lg:w-auto mb-10 flex lg:hidden justify-center lg:px-8 xl:px-0 sm:pr-8">
          <div className="rounded-[55px] w-[1299px] p-[40px] lg:p-[65px] border-2 border-transparent grad-border borderimage">
            ...
            <p className="mt-5 md:mt-10 font-circular-spotify text-[20px] font-light leading-[31px] text-left text-[#4F535B]">
            ...
            <p className="lg:hidden hidden md:block mt-5 md:mt-10 font-circular-spotify text-[20px] font-light leading-[31px] text-left text-[#4F535B]">
              Morbi interdum mollis sapien. Sed ac risus. Phasellus lacinia,
              magna a ullamcorper laoreet, lectus arcu pulvinar risus, vitae
              facilisis libero dolor a purus. Sed vel lacus. Mauris nibh felis,
              adipiscing varius, adipiscing in, lacinia vel, tellus. Suspendisse
            ...
            <p className="lg:hidden block md:hidden mt-5 md:mt-10 font-circular-spotify text-[20px] font-light leading-[31px] text-left text-[#4F535B]">
              Morbi interdum mollis sapien. Sed ac risus. Phasellus lacinia,
              magna a ullamcorper laoreet, lectus arcu pulvinar risus, vitae
              facilisis libero dolor a purus. Sed vel lacus. Mauris nibh felis,
              adipiscing varius, adipiscing in, lacinia vel, tellus. Suspendisse
            ...
            <p className="hidden lg:block mt-5 md:mt-10 font-circular-spotify text-[20px] font-light leading-[31px] text-left text-[#4F535B]">
      ...
      <div className="mt-10 sm:mt-0 lg:mt-28 sm:w-[50%] lg:w-auto mb-10 flex justify-center lg:px-8 xl:px-0 sm:pr-8">
          <div className="rounded-[55px] w-[1299px] p-[40px] md:p-[65px] border-2 border-transparent grad-border borderimage">
            <h2 className="font-inter text-[27px] font-normal leading-[32.68px] text-left text-[#282828]">
              Our Story
            </h2>
            <p className="mt-5 md:mt-10 font-circular-spotify text-[20px] font-light leading-[31px] text-left text-[#4F535B]">
