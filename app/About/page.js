          ...
          <div className="text-center">
            ...
            <div className="flex justify-center mt-6 sm:mt-8 md:mt-10">
              <p className="font-circular-spotify px-[0px] md:px-[60px] lg:px-[120px] xl:px-[170px] 2xl:px-[300px] text-[18px] lg:text-[22px] xl:text-[27px] font-light leading-[25.4px] lg:leading-[38.1px] text-[#666666] text-center">
                We are a dedicated bunch of trailblazers who are passionate
                about innovation in the payments space. We understand payments
                inside-out - from a technical as well as a business perspective.
                Each one of us is closely involved in building products we
                believe in.
              </p>
            </div>
          </div>
          ...
          <div className="py-10 lg:py-0 relative block sm:flex lg:block sm:w-[100%] sm:gap-8">
            <div className="sm:w-[50%] lg:w-auto">
              <div className="block lg:flex lg:w-[100%]">
                <div className="lg:w-[50%] flex lg:items-center lg:justify-center lg:h-[500px]">
                  <div>
                    ...
                    <p className="font-circular-spotify text-[16px] lg:text-[18px] font-light leading-[22.58px] lg:leading-[25.4px] text-left text-[#4F535B] mt-4 lg:mt-8 lg:w-[433px]">
                      ...
                      there were more than 15 billion paper checks sent within
                      the US. To address the deficiencies of offline payments,
                      we have built the most efficient push payments platform.
                      It not only provides a solution to the inefficiencies of
                      paper checks, but also provides a flexible way to transmit
                      funds in real-time.
                    </p>
                  </div>
                </div>
                <div className=" lg:w-[50%] sm:px-0 rounded-[60px] sm:rounded-[50px] lg:rounded-[118px_0px_0px_118px] bg-[#FFFFFF]">
                  <div className="px-10 py-10 md:px-0 md:py-8 2xl:pr-64 md:mx-8 lg:mx-[80px] mt-8 md:mt-12 lg:mt-[80px] mb-8 md:mb-12 lg:mb-[80px]">
                    <p className="font-inter text-[25px] lg:text-[33px] 2xl:text-[40px] font-normal leading-[33px] lg:leading-[48.41px] text-left text-[#282828] mx-auto lg:mx-0">
                      &quot;Our mission is to solve the challenges of push
                      payments by building a payouts platform for the digital
                      age.&quot;
                    </p>
                    <div className="flex mt-6 md:mt-8 lg:mt-10 gap-6">
                      <Image
                        alt="SpeakerPh"
                        src={SpeakerPh}
                        className="object-contain w-[20%] md:w-[25%] lg:w-[15%]"
                      />
                      <div className="mt-4">
                        <p className="font-inter text-[23px] lg:text-[27px] font-normal leading-[28.17px] md:leading-[28.17px] lg:leading-[29.83px] text-left text-[#7F53E8]">
                          PJ Gupta
                        </p>
                        <p className="font-circular-spotify text-[#282828] text-[17px] md:text-[18px] lg:text-[18px] font-light leading-[28.17px] md:leading-[28.17px] lg:leading-[29.83px] text-left">
                          CEO & Founder
                        </p>
                      </div>
                    </div>
                ...
                <div className="hidden justify-start mb-10 sm:block lg:hidden">
                  <CTAButton
                    icon={signupArrow}
            ...
            <div className="mt-10 sm:mt-0 lg:mt-28 sm:w-[50%] lg:w-auto mb-10 flex lg:hidden justify-center lg:px-8 xl:px-0">
              <div className="rounded-[55px] w-[1385px] p-[40px] sm:p-[30px] md:p-[45px] lg:p-[60px] border-2 border-transparent grad-border grad-border-def borderimage">
                ...
                <p className="lg:block hidden mt-10 font-circular-spotify text-[16px] lg:text-[20px] font-light leading-[22.58px] lg:leading-[31px] text-left text-[#4F535B]">
                  ...
                  diam sit amet mi ullamcorper vehicula. Integer adipiscing
                  risus a sem. Nullam quis massa sit amet nibh viverra
                  malesuada. Nunc sem lacus, accumsan quis, faucibus non, congue
                  vel, arcu. Ut scelerisque hendrerit tellus. Integer sagittis.
                  Vivamus a mauris eget arcu gravida tristique. Nunc iaculis mi
                  in ante. Vivamus imperdiet nibh feugiat est. Ut convallis, sem
                  sit amet interdum consectetuer, odio augue aliquam leo, nec
                  dapibus tortor nibh sed augue. Integer eu magna sit amet metus
                  fermentum posuere. Morbi sit amet nulla sed dolor elementum
                  ...
                  convallis. Morbi vitae ante. Vivamus ultrices luctus nunc.
                  Suspendisse et dolor. Etiam dignissim. Proin malesuada
          ...
          <div className="mt-10 sm:mt-0 lg:mt-28 sm:w-[50%] lg:w-auto mb-10 flex justify-center lg:px-8 xl:px-0 sm:pr-8">
            <div className="rounded-[55px] w-[1385px] p-[40px] lg:p-[60px] border-2 border-transparent grad-border grad-border-def borderimage">
              ...
              <p className="lg:block hidden mt-10 font-circular-spotify text-[16px] lg:text-[20px] font-light leading-[22.58px] lg:leading-[31px] text-left text-[#4F535B]">
                ...
                consectetuer, odio augue aliquam leo, nec dapibus tortor nibh
                sed augue. Integer eu magna sit amet metus fermentum posuere.
                Morbi sit amet nulla sed dolor elementum imperdiet. Quisque
                fermentum. Cum sociis natoque penatibus et magnis xdis
                parturient montes, nascetur ridiculus mus. Pellentesque
                adipiscing eros ut libero. Ut condimentum mi vel tellus.
                Suspendisse laoreet. Fusce ut est sed dolor gravida convallis.
                Morbi vitae ante. Vivamus ultrices luctus nunc. Suspendisse et
                dolor. Etiam dignissim. Proin malesuada adipiscing lacus. Donec
                metus. Curabitur gravida
              </p>
