    ...
    <div className="container main-con m-auto px-4 sm:px-0">
      <section className="pb-5 lg:pb-10 xl:py-20">
        <div className="">
          ...
          <p className="pt-5 lg:pt-[30px] text-center text-[18px] font-[300] lg:font-[400] 2xl:text-[27px] w-[100%] lg:w-[70%] m-auto">
      ...
      <section className="pb-20 md:pb-30">
        ...
        <div className="p-10 xl:p-20 bg-gradient-to-r from-[#9281FF] to-[#3E89BD] grad-border grad-border-webinar bdr-wbnr-rds shadow-bottom">
